     ...
     <div class="container">
      <div class="aa-catg-head-banner-content">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="${pageContext.request.contextPath}/ProductListClientController1">Sản phẩm</a></li>
          ...
          <div class="aa-product-details-area">
            <div class="aa-product-details-content">
              <div class="row">
               ...
               data-size="large">
               <a target="_blank" 
               href="https://www.facebook.com/sharer/sharer.php?u="{pageContext.request.contextPath}/"&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Chia sẻ</a>
               </div>
               -->
               ...
               data-action="like" data-size="small" data-share="true"></div>
                  ...
                  <div class="aa-product-view-content">
                    ...
                    <div class="aa-prod-view-bottom">
                      <a class="aa-add-to-cart-btn" href="${pageContext.request.contextPath}/AddtoCartController1?product-id=${detail_product.id}">Thêm vào giỏ hàng</a>
                    </div>
                    
                    <br>
                    <div class="fb-page" data-href="https://www.facebook.com/Quangnhan1111/" 
					data-tabs="timeline" data-width="" data-height="70" data-small-header="true" 
					data-adapt-container-width="true" data-hide-cover="false" 
					data-show-facepile="true"><blockquote cite="https://www.facebook.com/Quangnhan1111/"
 					class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/Quangnhan1111/">
					Shop hoa tươi sinh viên Bách Khoa Đà Nẵng - Hân Hân hoa khai trương</a></blockquote>
					</div>
                  </div>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane fade " id="review">
                 <div class="aa-product-review-area">
                   ...
                   <!-- review form -->
                   <form action="${pageContext.request.contextPath}/ReviewClientController1?id=${detail_product.id}" method="post" class="aa-review-form">
            ...
            <div class="aa-product-related-item">
              ...
              <ul class="aa-product-catg aa-related-item-slider">
                ...
                <c:forEach items="${productById}" var="product">
	                <li>
	                  <figure>
	                    <a class="aa-product-img" href="${pageContext.request.contextPath}/ProductDetailController1?id=${product.id}"><img src="${pageContext.request.contextPath}/view/client/assets/images/products/img-test/${product.image_link}" alt=""></a>
